...
public class PermissionsValidator {
    ...
    public static boolean validateTableName(String tableName, EnumSet<Permissions> perms) throws IllegalArgumentException {
    ...
    public static boolean validateDbFolder(String dbFolder, EnumSet<Permissions> perms) throws IllegalArgumentException {
    ...
    public static boolean validate(String fileName, EnumSet<Permissions> perms) throws IllegalArgumentException {
        ...
        if ((perms.contains(CREATE_FILE_IF_NOT_EXISTS) || perms.contains(CREATE_DIRECTORY_IF_NOT_EXISTS)) && !file.exists()) {
            try {
        ...
        if (perms.contains(CAN_READ) && !file.canRead()) {
            throw new IllegalArgumentException(file.getPath() + ": don't have permission to read the file");
        }
        if (perms.contains(CAN_WRITE) && !file.canWrite()) {
            throw new IllegalArgumentException(file.getPath() + ": don't have permission to write the file");
        }
